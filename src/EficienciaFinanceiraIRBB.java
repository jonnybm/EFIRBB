...
public class EficienciaFinanceiraIRBB extends javax.swing.JFrame {
	
	static EFIRBB EFIRBB = new EFIRBB();
    ...
    public EficienciaFinanceiraIRBB() {
        initComponents();
        setTitle("IR BBB");
    ...
    public static void main(String args[]) {
        (new EficienciaFinanceiraIRBB()).show();
	      jtaArea.setText(""
    ...
    public void rodarArquivos(final String pasta, final String pathExcel) {
		new Thread() {
			...
			public void run() {
        		...
        		EFIRBB.excelBB = pathExcel;
        		EFIRBB.caminho = pasta+"/";
